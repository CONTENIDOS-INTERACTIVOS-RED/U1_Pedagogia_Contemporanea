        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde sus orígenes, la pedagogía ha evolucionado como una ciencia fundamental para la comprensión y transformación de los procesos educativos. En esta unidad, se exploran los enfoques contemporáneos que han surgido como respuesta a los desafíos de la educación actual, permitiendo una mirada crítica y contextualizada sobre el rol del docente, el estudiante y el aprendizaje en escenarios cambiantes. Se abordarán los principales paradigmas pedagógicos contemporáneos, sus implicaciones para la práctica educativa y las estrategias que promueven ambientes de aprendizaje flexibles, inclusivos y significativos. Esta unidad te proporcionará las herramientas conceptuales necesarias para interpretar y aplicar enfoques pedagógicos innovadores que respondan a las demandas de una sociedad en constante transformación.
              
              p #[b ¡Prepárese para comprender y transformar los procesos educativos con una visión crítica, reflexiva e innovadora!]
